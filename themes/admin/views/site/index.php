...
<div class="heading-buttons">
    <h2>Dashboard<span class="hidden-phone">| Action is the foundational key to success</span></h2>
    <div class="buttons pull-right">
        <a href="" class="btn btn-default btn-icon glyphicons edit"><i></i> Edit</a>
        <a href="#" class="btn-action border-only circle glyphicons cardio btn-primary hidden-phone"><i></i></a>
    </div>

...
{
	const CSS_FIRST_PAGE='paginate_button first';
	const CSS_LAST_PAGE='paginate_button last';
	const CSS_PREVIOUS_PAGE='paginate_button previous';
	const CSS_NEXT_PAGE='paginate_button next';
	...
	public function init()
	{
		...
		$this->htmlOptions['style']='margin-right: 2px';
	}

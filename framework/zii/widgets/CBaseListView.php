...
abstract class CBaseListView extends CWidget
{
	...
	{
		$emptyText=$this->emptyText===null ? Yii::t('strings','No results found.') : $this->emptyText;
	...
	public function renderSummary()
	{
		...
		//echo '<div style="float:left"><i class="load ace-icon fa fa-spin orange bigger-200"></i></div><div class="'.$this->summaryCssClass.'">';
		echo '<div class="space-10"></div><div class="'.$this->summaryCssClass.'">';
		if($this->enablePagination)
		{
			...
			if(($summaryText=$this->summaryText)===null)
				$summaryText=Yii::t('zii','Displaying {start}-{end} of 1 result.',$total);

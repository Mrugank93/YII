...
class CButtonColumn extends CGridColumn
{
	 ...
	 */
	public $viewButtonOptions=array('class'=>'blue ace-icon fa fa-search-plus bigger-130');
	 ...
	 */
	public $updateButtonOptions=array('class'=>'green ace-icon fa fa-pencil bigger-130');
	 ...
	 */
	public $deleteButtonOptions=array('class'=>'red ace-icon fa fa-trash-o bigger-130','id'=>'bootbox-confirm');
	/**
	...
	protected function initDefaultButtons()
	{
		...
		if($this->deleteConfirmation===null)
			$this->deleteConfirmation=Yii::t('strings','Are you sure you want to delete this item?');
...
EOD;
	...
	protected function renderButton($id,$button,$row,$data)
	{
		...
		if(isset($button['label']) && is_string($button['label']))

...
EOD;
	...
	protected function renderHeaderCellContent()
	{
		...
		if($this->selectableRows===null && $this->grid->selectableRows>1)
			$item = '<label class="position-relative">'.CHtml::checkBox($this->id.'_all',false,array('class'=>'ace select-on-check-all')).'<span class="lbl"></span></label>';
		elseif($this->selectableRows>1)
			$item = '<label class="position-relative">'.CHtml::checkBox($this->id.'_all',false,array('class'=>'ace')).'<span class="lbl"></span></label>';
		else
		{
			ob_start();

...
class GalleryController extends Controller
{
	...
	function actionUpload() {
		...
		$folder='gallery/';// folder for uploaded files
		...
		if($result['success'])
		{
			...
			if(!$model->save())
			{
				unlink(Yii::app()->basePath."/../gallery/".$result['filename']);
	...
	public function actionDelete($id)
	{
		...
		unlink(Yii::app()->basePath."/../gallery/".$model->name);

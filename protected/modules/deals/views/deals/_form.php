...
<div class="row-fluid">
    <div class="span6">
        ...
        <div class="control-group <?php if($model->hasErrors('purchase_min')!=null) echo 'error'; ?>">
            <?php echo $form->labelEx($model,'purchase_min',array('class'=>'control-label')); ?>
            <div class="controls">
                <?php echo $form->textField($model,'purchase_min',array('size'=>50,'maxlength'=>3)); ?>
                <?php echo $form->error($model,'purchase_min', array('class'=>'error help-block')); ?>
            </div>
        </div>


        <div class="control-group">
            <?php echo $form->labelEx($model,'purchase_max',array('class'=>'control-label')); ?>
            <div class="controls">
                <?php echo $form->textField($model,'purchase_max',array('size'=>45)); ?>
            </div>
        </div>

        <div class="control-group">
            <?php echo $form->labelEx($model,'limit_per_user',array('class'=>'control-label')); ?>
            <div class="controls">
                <?php echo $form->textField($model,'limit_per_user',array('size'=>45)); ?>
            </div>
        </div>

        <div class="control-group <?php if($model->hasErrors('redeem_date')!=null) echo 'error'; ?>">
            <?php echo $form->labelEx($model,'redeem_date',array('class'=>'control-label')); ?>
            <div class="controls">
                <?php
                $this->widget('zii.widgets.jui.CJuiDatePicker', array(
                    'model'=>$model,
                    'attribute'=>'redeem_date',
                    //'value'=>$model->lastday_deal_redeemed,
                ...
                ?>
                <?php echo $form->error($model,'redeem_date', array('class'=>'error help-block')); ?>
            </div>
        </div>


        <div class="control-group <?php if($model->hasErrors('purchase_date')!=null) echo 'error'; ?>">
            <?php echo $form->labelEx($model,'purchase_date',array('class'=>'control-label')); ?>
            <div class="controls">
                <?php
                $this->widget('zii.widgets.jui.CJuiDatePicker', array(
                    'model'=>$model,
                ...
                ?>
                <?php echo $form->error($model,'purchase_date', array('class'=>'error help-block')); ?>
            </div>
        </div>
    ...
    <div class="span6">
        <div id="deals">
            <div class="box1">
                <h2>Name Of Deal</h2>
                <div class="offerimage"><img src="#" ?>"/></div>
...
<?php
    ...
    {
        $str.= "'".Yii::app()->baseUrl.'/images/category/'.str_replace(' ','_', $val).".png',";
    }
...
<?php
    ...
    $('#Deals_deal_available').hide();
    $('label[for=\"Deals_deal_available\"]').hide();

    $('#Deals_deal_limit_0').change(function()
    {
            if( $(this).is(':checked') )
            {
                $('#Deals_deal_available').fadeOut(500);
                $('label[for=\"Deals_deal_available\"]').fadeOut(500);
            }
    });

    $('#Deals_deal_limit_1').change(function()
    {
            if( $(this).is(':checked') )
            {
                $('#Deals_deal_available').fadeIn(500);
                $('label[for=\"Deals_deal_available\"]').fadeIn(500);
            }
    });
